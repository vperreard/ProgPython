...
# Remonter à la racine depuis modules/invoices
PROJECT_ROOT = os.path.abspath(os.path.join(current_dir, "..", ".."))

# Nouveau chemin pour la base de données des factures
FACTURES_DB = os.path.join(PROJECT_ROOT, "data", "invoices", "factures_db.json")
...
def charger_base_donnees():
    ...
    os.makedirs(os.path.dirname(FACTURES_DB), exist_ok=True)
